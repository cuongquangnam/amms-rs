...
use crate::amm::uniswap_v3::factory::POOL_CREATED_EVENT_SIGNATURE;
...
pub struct UniswapV3PoolCustomized {
    pub address: H160,
    pub token_a: H160,
...
#[async_trait]
impl AutomatedMarketMaker for UniswapV3PoolCustomized {
...
impl UniswapV3PoolCustomized {
    ...
    pub async fn new_from_address<M: 'static + Middleware>(
        ...
        let mut pool = UniswapV3PoolCustomized {
    ...
    pub async fn new_from_log<M: 'static + Middleware>(
        ...
        if event_signature == POOL_CREATED_EVENT_SIGNATURE {
            if let Some(block_number) = log.block_number {
                ...
                UniswapV3PoolCustomized::new_from_address(
    ...
    pub async fn get_tick_word<M: Middleware>(
        ...
        let v3_pool = IUniswapV3PoolCustomized::new(self.address, middleware);
    ...
    pub async fn get_tick_info<M: Middleware>(
        ...
        let v3_pool = IUniswapV3PoolCustomized::new(self.address, middleware.clone());
    ...
    pub async fn get_fee<M: Middleware>(&mut self, middleware: Arc<M>) -> Result<u32, AMMError<M>> {
        let fee = IUniswapV3PoolCustomized::new(self.address, middleware)
            .fee()
            .call()
            .await?;
...
#[cfg(test)]
mod test {
    use super::IUniswapV3PoolCustomized;
    #[allow(unused)]
    #[allow(unused)]
    ...
    async fn initialize_usdc_weth_pool<M: 'static + Middleware>(
        middleware: Arc<M>,
    ) -> eyre::Result<(UniswapV3PoolCustomized, u64)> {
        let mut pool = UniswapV3PoolCustomized {
    ...
    async fn test_get_new_from_address() -> eyre::Result<()> {
        ...
        let pool = UniswapV3PoolCustomized::new_from_address(
    ...
    async fn test_calculate_virtual_reserves() -> eyre::Result<()> {
        ...
        let pool_at_block = IUniswapV3PoolCustomized::new(
            H160::from_str("0x88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640")?,
            middleware.clone(),
        );
    ...
    async fn test_calculate_price() -> eyre::Result<()> {
        ...
        let block_pool = IUniswapV3PoolCustomized::new(
            H160::from_str("0x88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640")?,
            middleware.clone(),
        );
    ...
    async fn test_get_new_from_address_and_block_number() -> eyre::Result<()> {
        ...
        let pool = UniswapV3PoolCustomized::new_from_address_and_block_number(
            H160::from_str("0x88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640")?,
            12369620,
            middleware.clone(),
            block_number,
